...
public sealed class LifeSaverBadgeRule(IApplicationDbContext dbContext) : IBadgeRule
{
    public string BadgeKey => "life_saver";
    ...
    public async Task<bool> IsEarnedAsync(GamificationContext context, CancellationToken cancellationToken)
    {
        ...
        return donor.TotalDonationCount + 1 >= 10;
    }
}
